 ...
 **************************************************/
#ifdef CONFIG_MISC_OPT_OVERCLOCK
#define SEG3_GPU_DVFS_FREQ0			(800000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ1			(700000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ2			(680000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ3			(500000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ4			(400000)	/* KHz */

#define SEG3_GPU_DVFS_VOLT0			(85200)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT1			(83000)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT2			(80000)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT3			(70000)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT4			(65000)		/* mV x 100 */
...
#else /* !CONFIG_MISC_OPT_OVERCLOCK */
